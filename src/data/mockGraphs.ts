...
export const mockGraphs: KnowledgeGraph[] = [
  {
    ...
    nodes: [
      {
        ...
        type: 'product',
        description:
          '현재 보유 기기로 가정한 소형 아이폰입니다. 사용 기간이 길어질수록 배터리와 성능 체감이 구매 판단에 영향을 줍니다.',
      },
      {
        id: 'iphone-17',
        label: 'iPhone 17',
        type: 'product',
        description:
          '구매 후보가 되는 새 모델입니다. 출시 직후에는 가격 방어가 강하지만 다음 세대가 가까워질수록 감가상각 리스크가 커질 수 있습니다.',
      },
      {
        id: 'iphone-18',
        label: 'iPhone 18',
        type: 'product',
        description:
          '다음 세대로 예상되는 모델입니다. 기다릴 때 얻을 수 있는 성능 개선과 기회비용을 비교하는 기준점입니다.',
      },
      {
        id: 'release-cycle',
        label: '출시 주기',
        type: 'factor',
        description:
          '스마트폰 신제품이 반복적으로 공개되는 시간 패턴입니다. 구매 시점을 늦출지 결정할 때 중요한 맥락입니다.',
      },
      {
        id: 'depreciation',
        label: '감가상각',
        type: 'factor',
        description:
          '새 제품 구매 후 시간이 지나며 중고 가치가 하락하는 현상입니다. 총소유비용을 판단할 때 고려합니다.',
      },
      {
        id: 'battery-health',
        label: '배터리 성능',
        type: 'factor',
        description:
          '현재 기기를 계속 써도 되는지 결정하는 가장 직접적인 체감 지표입니다.',
      },
      {
        ...
        type: 'decision',
        description:
          '필요성, 비용, 기다림의 가치, 현재 기기의 불편함을 함께 본 최종 판단 지점입니다.',
      },
    ],
    edges: [
      {
        ...
        description:
          '오래 사용한 iPhone 13 mini는 배터리 성능 저하의 영향을 받습니다.',
      },
      {
        source: 'iphone-17',
        target: 'iphone-18',
        ...
        description:
          'iPhone 17 이후 다음 세대인 iPhone 18이 출시될 가능성을 고려합니다.',
      },
      {
        source: 'iphone-18',
      ...
      },
      {
        ...
        relation: 'affected_by',
        description:
          '새 모델 구매 시점과 다음 세대 출시 시점은 감가상각에 영향을 줍니다.',
      },
      {
        source: 'depreciation',
    ...
    recommendation:
      '배터리 성능, 현재 중고가, 예상 사용 기간을 먼저 확인해 총소유비용을 비교하세요.',
  },
  {
    ...
    nodes: [
      {
        ...
        type: 'event',
        description:
          '원유 가격 상승은 에너지 비용과 석유 기반 원자재 가격을 동시에 밀어 올릴 수 있습니다.',
      },
      {
        id: 'energy-cost',
        label: '에너지 비용',
      ...
      },
      {
        ...
        type: 'decision',
        description:
          '매출에서 비용을 뺀 수익성 지표입니다. 원가 상승을 가격에 전가하지 못하면 악화됩니다.',
      },
      {
        id: 'price-transfer',
        label: '가격 전가',
    ...
    edges: [
      {
        ...
        relation: 'raises',
        description:
          '유가 상승은 전력과 연료 사용 비용을 증가시킬 수 있습니다.',
      },
      {
        source: 'oil-price',
      ...
      },
      {
        ...
        relation: 'reduces',
        description:
          '생산 원가가 오르면 가격을 올리지 않는 한 영업 마진이 줄어듭니다.',
      },
      {
        source: 'production-cost',
    ...
    recommendation:
      '분석 대상 기업의 에너지 사용 비중과 가격 전가 가능성을 먼저 확인하세요.',
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'factor',
        description:
          '이동에 쓰는 시간과 피로도입니다. 재택근무에서는 크게 줄어듭니다.',
      },
      {
        id: 'focus-time',
        label: '몰입 시간',
    ...
    edges: [
      ...
      },
      {
        ...
        relation: 'frees',
        description:
          '줄어든 이동 시간은 몰입 가능한 시간으로 전환될 수 있습니다.',
      },
      {
        source: 'focus-time',
        target: 'productivity',
      ...
      },
      {
        ...
        relation: 'can_raise',
        description:
          '비대면 환경에서는 문맥 공유와 의사결정 비용이 증가할 수 있습니다.',
      },
      {
        ...
        relation: 'weakens',
        description:
          '커뮤니케이션 비용이 높아지면 팀 정렬이 약해질 수 있습니다.',
      },
      {
    ...
    recommendation:
      '업무를 개인 몰입형과 협업형으로 나눠 재택 비율을 다르게 설계하세요.',
  },
  {
    id: 'ai-education',
    ...
    nodes: [
      {
        ...
        type: 'concept',
        description:
          '질문에 답하고 예시를 만들며 학습 과정을 보조하는 도구입니다.',
      },
      {
        id: 'instant-feedback',
        label: '즉시 피드백',
        type: 'factor',
        description:
          '학습자가 바로 설명과 수정 방향을 받을 수 있는 특성입니다.',
      },
      {
        id: 'personalization',
        label: '개인화 설명',
        type: 'factor',
        description:
          '학습자의 수준과 관심사에 맞춰 설명을 조절하는 방식입니다.',
      },
      {
        id: 'overreliance',
        label: '의존성',
    ...
    edges: [
      {
        ...
        relation: 'enables',
        description:
          '생성형 AI는 질문에 빠르게 반응해 즉시 피드백을 제공합니다.',
      },
      {
        source: 'gen-ai',
      ...
      },
      {
        ...
        relation: 'affects',
        description:
          '비판적 사고는 AI를 학습 도구로 건강하게 쓰는 핵심 조건입니다.',
      },
    ],
    summary:
    ...
    recommendation:
      'AI 답변을 받은 뒤 근거 확인과 자기 말로 재설명하는 단계를 과제에 포함하세요.',
  },
  {
    ...
    nodes: [
      {
        ...
        type: 'event',
        description:
          '정해진 시간에 내용을 전달하고 질문에 대응해야 하는 업무 이벤트입니다.',
      },
      {
        id: 'prep-time',
        label: '준비 시간',
        type: 'factor',
        description:
          '자료 정리, 흐름 점검, 예상 질문 준비에 필요한 시간입니다.',
      },
      {
      ...
      },
      {
        ...
        type: 'factor',
        description:
          '회의 일정 변경, 자료 오류, 이동 지연처럼 당일에 생길 수 있는 변수입니다.',
      },
      {
        id: 'storyline',
        label: '발표 흐름',
        type: 'factor',
        description:
          '핵심 메시지와 근거가 자연스럽게 이어지는 발표 구조입니다.',
      },
      {
        id: 'confidence',
        label: '발표 자신감',
        type: 'factor',
        description:
          '준비 정도에 따라 발표 중 말의 안정성과 대응력이 달라집니다.',
      },
      {
        id: 'decision',
        label: '준비 시점 결정',
        type: 'decision',
        description:
          '오늘 저녁에 일부 준비할지, 내일 아침에 몰아서 할지 정하는 판단입니다.',
      },
    ],
    edges: [
      {
      ...
      },
      {
        ...
        relation: 'affects',
        description:
          '아침 컨디션이 나쁘면 계획한 준비 시간을 제대로 쓰기 어렵습니다.',
      },
      {
        ...
        description:
          '돌발 변수가 많을수록 내일 아침에 몰아 준비하는 위험이 커집니다.',
      },
      {
        source: 'storyline',
        target: 'confidence',
        relation: 'supports',
        description:
          '발표 흐름이 잡히면 자신감과 질의응답 대응력이 좋아집니다.',
      },
      {
        source: 'confidence',
        target: 'decision',
        relation: 'affects',
        description:
          '자신감이 낮으면 최소한의 리허설을 오늘 해두는 편이 유리합니다.',
      },
    ],
    summary:
    ...
    recommendation:
      '오늘 30분만 써서 목차, 핵심 메시지 3개, 예상 질문 2개를 먼저 적어두세요.',
  },
  {
    id: 'coffee-sleep',
    ...
    nodes: [
      {
        ...
        type: 'event',
        description:
          '늦은 시간에 카페인을 섭취해 당장 졸림을 줄이려는 선택입니다.',
      },
      {
        ...
        type: 'factor',
        description:
          '커피를 마신 직후 졸림이 줄고 잠깐 집중이 쉬워지는 효과입니다.',
      },
      {
        id: 'sleep-quality',
        label: '수면 질',
        type: 'factor',
        description:
          '잠드는 속도, 깊은 잠, 중간 각성 여부를 포함한 회복 지표입니다.',
      },
      {
        id: 'sleep-debt',
        label: '수면 부족',
        type: 'factor',
        description:
          '수면 시간이 줄거나 질이 낮아져 다음날 회복이 덜 된 상태입니다.',
      },
      {
        id: 'tomorrow-focus',
        label: '내일 집중력',
      ...
      },
      {
        ...
        type: 'factor',
        description:
          '짧은 휴식, 물 마시기, 작업 범위 줄이기처럼 수면을 덜 해치는 대안입니다.',
      },
      {
        id: 'coffee-decision',
        label: '커피 선택',
        type: 'decision',
        description:
          '밤에 커피를 마시는 것이 내일 집중력 관점에서 합리적인지 판단하는 지점입니다.',
      },
    ],
    edges: [
      {
      ...
      },
      {
        ...
        relation: 'can_reduce',
        description:
          '늦은 카페인은 잠들기 어렵게 하거나 수면 깊이를 낮출 수 있습니다.',
      },
      {
      ...
      },
      {
        ...
        description:
          '단기 각성 효과는 오늘 반드시 끝낼 일이 있을 때만 커피 선택을 일부 정당화합니다.',
      },
      {
        ...
        description:
          '긴급 마감이 있으면 내일 컨디션보다 오늘 처리의 가치가 커질 수 있습니다.',
      },
      {
      ...
      },
      {
        ...
        description:
          '대안 행동이 가능하면 커피 없이 오늘 할 일을 줄이고 수면을 지키는 편이 낫습니다.',
      },
    ],
    summary:
    ...
    recommendation:
      '커피 대신 물을 마시고 20분만 핵심 작업을 줄인 뒤, 수면 시간을 확보하는 쪽을 우선하세요.',
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'factor',
        description:
          '다른 서비스로 옮길 때 드는 시간, 학습, 데이터 이전 비용입니다.',
      },
      {
        id: 'competitor-price',
        label: '경쟁사 가격',
    ...
    edges: [
      ...
      },
      {
        ...
        relation: 'supports',
        description:
          '명확한 커뮤니케이션은 고객이 인상 이유와 가치를 이해하도록 돕습니다.',
      },
      {
        source: 'churn-risk',
        target: 'revenue',
        relation: 'affects',
        description:
          '이탈이 커지면 가격을 올려도 매출 개선이 제한될 수 있습니다.',
      },
    ],
    summary:
    ...
    recommendation:
      '전체 인상 전에 충성 고객군과 가격 민감 고객군을 나눠 소규모 테스트를 먼저 진행하세요.',
  },
  {
    id: 'used-ev',
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'factor',
        description:
          '사용 기간과 충전 습관에 따라 배터리 용량이 줄어드는 현상입니다.',
      },
      {
        id: 'charging-access',
        label: '충전 접근성',
      ...
      },
      {
        ...
        type: 'decision',
        description:
          '생활 패턴과 비용 조건을 종합해 구매해도 되는지 판단하는 지점입니다.',
      },
    ],
    edges: [
      {
      ...
      },
      {
        ...
        relation: 'affects',
        description:
          '충전 접근성이 낮으면 전기차 사용 편의성이 크게 떨어집니다.',
      },
      {
    ...
    recommendation:
      '구매 전 배터리 진단서, 실제 주행 가능 거리, 집이나 회사 충전 가능 여부를 먼저 확인하세요.',
  },
];
...
export function findGraphByQuestion(query: string): KnowledgeGraph {
  ...
  // 1. 매우 정확한 일치 우선 (질문 또는 제목이 완전히 일치)
  let found = mockGraphs.find((graph) =>
    [graph.question, graph.title].some(
      (term) => normalized === term.toLowerCase(),
    ),
  );
  if (found) return found;

  // 2. 제목이나 질문을 포함하는 일치
  found = mockGraphs.find((graph) =>
    [graph.question, graph.title].some(
      (term) =>
  ...
  // 3. 키워드 일치 (모든 키워드 검사)
  found = mockGraphs.find((graph) =>
    graph.keywords.some((term) => normalized.includes(term.toLowerCase())),
  );
  if (found) return found;
